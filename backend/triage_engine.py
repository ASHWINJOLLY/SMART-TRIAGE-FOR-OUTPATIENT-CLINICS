...
You are a medical triage AI for a hospital.
...
INSIGHTS_PROMPT = """
You are analyzing the OPD queue. Current queue data:
{queue_snapshot}
...
def _fallback_triage(patient_data: dict) -> dict:
    ...
    danger_words = ['chest pain', 'seene', 'dard', 'saans', 'breathing', 'breathless', 'unconscious', 'behosh', 'bleeding', 'khoon', 'seizure', 'mirgi', 'heart attack', 'dil ka daura', 'accident', 'hadsa', 'poison', 'zeher', 'choking', 'drowning', 'paralysis', 'fits', 'burn', 'jal gaya']
