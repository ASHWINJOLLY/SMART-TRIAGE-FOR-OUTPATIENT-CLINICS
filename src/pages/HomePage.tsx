...
const criticalConversation = [
  { role: 'ai', text: 'Hello! Please describe your symptoms' },
  { role: 'patient', text: 'Chest pain, difficulty breathing', delay: 1500 },
  { role: 'ai', text: '🚨 CRITICAL — EMG-2045\nEmergency Bay C-204 — Go immediately!', isCritical: true, delay: 1000 }
];

const normalConversation = [
  { role: 'ai', text: 'Hello! Please describe your symptoms' },
  { role: 'patient', text: 'Fever for 5 days', delay: 1500 },
    ...
    <div className="homepage-wrapper">
        ...
        <div className="home-content">
          ...
          <div className="home-text-side">
            ...
            <p className="home-subtitle">
               SYMPTORA detects critical cases instantly and routes patients to the right doctor — in Hindi, English & 8 Indian languages.
            </p>
          ...
          <div className="home-visual-side">
            <div className="phone-mockup">
              ...
              <div className="phone-header">
                ...
                <div>
                  <div className="phone-name">SYMPTORA</div>
      ...
      <div className="how-it-works-container" id="features">
        <div className="how-it-works-content">
          <h2 className="section-title-large">How SYMPTORA Works</h2>
          ...
          <div className="agents-grid">
            ...
            <div className="agent-card">
              ...
              <p className="agent-description">
                Maps symptoms to correct department and specialist automatically
              </p>
            </div>
  ...
  return (
    <div className="live-stats-container">
      <div className="live-stats-content">
        <h2 className="live-stats-title">OPD — Live Today</h2>
  ...
  return (
    <div className="try-it-live-container">
      <div className="try-it-live-content">
        <h2 className="section-title-large">See SYMPTORA in Action</h2>
        <p className="section-subtitle-large">Click any case to try live triage</p>
        
        <div className="demo-buttons-grid">
          <button 
            className="demo-btn demo-btn-red"
            onClick={() => handleDemoClick('I have severe chest pain')}
          >
            <div className="demo-btn-title">🚨 Chest Pain — Critical</div>
            <div className="demo-btn-text">"I have severe chest pain"</div>
          </button>
          
          <button 
            className="demo-btn demo-btn-yellow"
            onClick={() => handleDemoClick('I have had high fever for 5 days')}
          >
            <div className="demo-btn-title">⚠️ Fever — Moderate</div>
            <div className="demo-btn-text">"I have had high fever for 5 days"</div>
          </button>
          
          <button 
            className="demo-btn demo-btn-green"
            onClick={() => handleDemoClick('My leg feels broken, severe pain')}
          >
            <div className="demo-btn-title">✅ Fracture — Ortho</div>
            <div className="demo-btn-text">"My leg feels broken, severe pain"</div>
          </button>
        </div>
