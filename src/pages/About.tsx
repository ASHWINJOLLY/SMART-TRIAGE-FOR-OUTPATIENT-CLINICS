  ...
  return (
    <div className="about-container">
      <div className="animate-fade-in-up">
        <h1>🏥 SYMPTORA</h1>
        <h2>Intelligent OPD Triage & Queue Management System</h2>
      </div>
      ...
      <div className="glass-card about-section animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
        ...
        <p>
          Most large hospitals handle thousands of OPD patients daily. 
      ...
      <div className="glass-card about-section animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
        ...
        <p>
          SYMPTORA is an agentic triage system that pre-triages patients via a WhatsApp-style 
      ...
      <div className="glass-card about-section animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
        <h3><Users size={20} style={{ display: 'inline', verticalAlign: 'middle', marginRight: 8 }} />TEAM FELIX</h3>
        <p>
          Built for AAYAM 2026, demonstrating AI-powered healthcare triage.
        </p>
        <p style={{ marginTop: 12 }}>
          <Zap size={16} style={{ display: 'inline', verticalAlign: 'middle', marginRight: 4, color: '#00d4aa' }} />
          <em>"Technology for better healthcare."</em>
        </p>
      </div>
